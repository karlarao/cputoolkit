...
b.	If the server has 256 max CPUs you can do the benchmark by 40 CPUs increment, and per increment it will run for 10 minutes
...
./runcputoolkit-auto 1 40 281 dw1
run for 1 CPU/s
run for 41 CPU/s
run for 81 CPU/s
run for 121 CPU/s
